...
import
  ...
  ./event_callback, rmw/event_callback_type, ./macros, rcutils/macros, ./node,
  ./allocator, rcutils/allocator, rcutils/types/rcutils_ret,
  rcutils/visibility_control, rcutils/visibility_control_macros, ./arguments,
  ./log_level, ./types, rmw/types, rcutils/logging, rcutils/error_handling,
  ...
  ./guard_condition, ./node_options, ./domain_id, rmw/message_sequence
...
type
  ...
  rcl_subscription_options_t* {.importc: "rcl_subscription_options_t",
    ...
    rmw_subscription_options* {.importc: "rmw_subscription_options".}: rmw_subscription_options_t ##
