...
import
  ...
  rcutils/types/rcutils_ret, rcutils/visibility_control_macros, ./arguments,
  ./log_level, ./types, rcutils/logging,
  ...
  ./node_options, ./domain_id, rmw/message_sequence


type

  rcl_subscription_impl_t* {.importc: "rcl_subscription_impl_t",
