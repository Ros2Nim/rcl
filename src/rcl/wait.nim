...
import
  ...
  ./node_options, ./domain_id, ./domain_id, ./node_options, ./node, ./client,
  ./service, ./service, ./subscription, ./subscription, rmw/message_sequence,
  rmw/message_sequence, rmw/message_sequence, ./subscription, ./timer, ./timer,
  ./time, ./time, ./timer, rmw/rmw, rmw/rmw, rosidl_runtime_c/sequence_bound,
  rosidl_runtime_c/sequence_bound, rmw/rmw, rmw/event, rmw/event, rmw/rmw,
  rmw/publisher_options, rmw/rmw, rmw/qos_profiles, rmw/rmw,
  rmw/subscription_options, rmw/rmw, ./timer, ./event, ./event, ./publisher,
  ./publisher, ./event
...
type
  ...
  rcl_wait_set_t* {.importc: "rcl_wait_set_t", header: "wait.h", bycopy.} = object ##
...
proc rcl_get_zero_initialized_wait_set*(): rcl_wait_set_t {.
    importc: "rcl_get_zero_initialized_wait_set", header: "wait.h".}
  ##
...
proc rcl_wait_set_init*(wait_set: ptr rcl_wait_set_t;
    ...
    importc: "rcl_wait_set_init", header: "wait.h".}
  ##
...
proc rcl_wait_set_fini*(wait_set: ptr rcl_wait_set_t): rcl_ret_t {.
    importc: "rcl_wait_set_fini", header: "wait.h".}
  ##
...
proc rcl_wait_set_get_allocator*(wait_set: ptr rcl_wait_set_t;
    ...
    importc: "rcl_wait_set_get_allocator", header: "wait.h".}
  ##
...
proc rcl_wait_set_add_subscription*(wait_set: ptr rcl_wait_set_t;
    ...
    importc: "rcl_wait_set_add_subscription", header: "wait.h".}
  ##
...
proc rcl_wait_set_clear*(wait_set: ptr rcl_wait_set_t): rcl_ret_t {.
    importc: "rcl_wait_set_clear", header: "wait.h".}
  ##
...
proc rcl_wait_set_resize*(wait_set: ptr rcl_wait_set_t;
    ...
    importc: "rcl_wait_set_resize", header: "wait.h".}
  ##
...
proc rcl_wait_set_add_guard_condition*(wait_set: ptr rcl_wait_set_t;
    ...
    importc: "rcl_wait_set_add_guard_condition", header: "wait.h".}
  ##
...
proc rcl_wait_set_add_timer*(wait_set: ptr rcl_wait_set_t;
    ...
    importc: "rcl_wait_set_add_timer", header: "wait.h".}
  ##
...
proc rcl_wait_set_add_client*(wait_set: ptr rcl_wait_set_t;
    ...
    importc: "rcl_wait_set_add_client", header: "wait.h".}
  ##
...
proc rcl_wait_set_add_service*(wait_set: ptr rcl_wait_set_t;
    ...
    importc: "rcl_wait_set_add_service", header: "wait.h".}
  ##
...
proc rcl_wait_set_add_event*(wait_set: ptr rcl_wait_set_t;
    ...
    importc: "rcl_wait_set_add_event", header: "wait.h".}
  ##
...
proc rcl_wait*(wait_set: ptr rcl_wait_set_t; timeout: int64): rcl_ret_t {.
    importc: "rcl_wait", header: "wait.h".}
...
proc rcl_wait_set_is_valid*(wait_set: ptr rcl_wait_set_t): _Bool {.
    importc: "rcl_wait_set_is_valid", header: "wait.h".}
  ##
