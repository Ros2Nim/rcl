...
import
  ...
  rmw/security_options, ./allocator, ./arguments, ./log_level, ./macros,
  ...
  rcl_yaml_param_parser/types, ./init_options
...
proc rcl_get_zero_initialized_context*(): rcl_context_t {.
    importc: "rcl_get_zero_initialized_context", header: "rcl/context.h".}
  ##
                              ##  Return a zero initialization context object.

proc rcl_context_fini*(context: ptr rcl_context_t): rcl_ret_t {.
    importc: "rcl_context_fini", header: "rcl/context.h".}
  ##
                              ##  Finalize a context.
                              ##
...
proc rcl_context_get_init_options*(context: ptr rcl_context_t): ptr rcl_init_options_t {.
    importc: "rcl_context_get_init_options", header: "rcl/context.h".}
  ##
...
proc rcl_context_get_instance_id*(context: ptr rcl_context_t): rcl_context_instance_id_t {.
    importc: "rcl_context_get_instance_id", header: "rcl/context.h".}
  ##
...
proc rcl_context_get_domain_id*(context: ptr rcl_context_t;
    ...
    importc: "rcl_context_get_domain_id", header: "rcl/context.h".}
  ##
...
proc rcl_context_get_rmw_context*(context: ptr rcl_context_t): ptr rmw_context_t {.
    importc: "rcl_context_get_rmw_context", header: "rcl/context.h".}
  ##
