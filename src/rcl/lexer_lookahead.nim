...
import
  ...
  rcutils/visibility_control, rcutils/allocator, ./allocator, ./lexer, ./lexer,
  ./macros, ./lexer, ./types, rmw/types, rmw/types, rmw/types, rcutils/logging,
  ...
  rmw/types, ./types, ./lexer, ./visibility_control, ./visibility_control,
  ./lexer
